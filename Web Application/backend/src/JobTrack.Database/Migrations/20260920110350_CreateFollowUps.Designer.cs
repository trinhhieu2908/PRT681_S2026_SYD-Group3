...
namespace JobTrack.Database.Migrations
{
    ...
    [Migration("20260920110350_CreateFollowUps")]
    partial class CreateFollowUps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobTrack.Modules.FollowUps.Entities.FollowUp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobApplicationId", "IsCompleted", "DueDate");

                    b.ToTable("follow_up", null, t =>
                        {
                            t.HasCheckConstraint("CK_follow_up_Completion", "(\"IsCompleted\" = TRUE AND \"CompletedAtUtc\" IS NOT NULL) OR (\"IsCompleted\" = FALSE AND \"CompletedAtUtc\" IS NULL)");
                        });
                });

            modelBuilder.Entity("JobTrack.Modules.Interviews.Entities.Interview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobApplicationId", "ScheduledAtUtc");
            ...
            modelBuilder.Entity("JobTrack.Modules.FollowUps.Entities.FollowUp", b =>
                {
                    b.HasOne("JobTrack.Modules.JobApplication.Entities.JobApplication", "JobApplication")
                        .WithMany()
